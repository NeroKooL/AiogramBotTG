...
def sql_start():
    global base, cur
    base = sq.connect('./data/test.db')
    cur = base.cursor()
    if base:
        print('DATA BASE test connected!')
    base.execute('CREATE TABLE IF NOT EXISTS test(img TEXT, name TEXT PRIMARY KEY, description TEXT, price TEXT)')
    base.commit()
